Contributing to LiteGoldCoinMN Core
============================

The LiteGoldCoinMN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the LiteGoldCoinMN Core project, and is not to be
confused with overall LiteGoldCoinMN Network Protocol consensus changes.

Whether a pull request is merged into LiteGoldCoinMN Core rests with the project merge
...
Patches that change LiteGoldCoinMN consensus rules are considerably more involved than
...
Where a patch set proposes to change the LiteGoldCoinMN consensus, it must have been
...
The project leader is the release manager for each LiteGoldCoinMN Core release.
