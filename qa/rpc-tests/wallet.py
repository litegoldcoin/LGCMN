...
#   c) node1 mines 32 blocks, so now node 0 has 60001lgcmn, node 1 has 4250lgcmn, node2 has none.
#   d) node0 sends 601 lgcmn to node2, in two transactions (301 lgcmn, then 300 lgcmn).
