...
In order to support loading of multiple wallets in litegoldcoinmn-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is litegoldcoinmn.cpp.
...
Changes to litegoldcoinmn.cpp
----------------------
litegoldcoinmn.cpp is the entry point into litegoldcoinmn-qt, and as such, will require some minor modifications to provide hooks for
