...
This mechanism has been integrated into Bitcore-Node-LiteGoldCoinMN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LiteGoldCoinMN-Project/insight-api-litegoldcoinmn#web-socket-api](https://github.com/LiteGoldCoinMN-Project/insight-api-litegoldcoinmn#web-socket-api) 
* API: [https://github.com/LiteGoldCoinMN-Project/insight-api-litegoldcoinmn#swifttx-transactions](https://github.com/LiteGoldCoinMN-Project/insight-api-litegoldcoinmn#swifttx-transactions) 
...
By default, the LiteGoldCoinMN Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LiteGoldCoinMN Core daemon:
