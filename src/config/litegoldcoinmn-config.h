/* src/config/litegoldcoinmn-config.h.  Generated from litegoldcoinmn-config.h.in by configure.  */
/* src/config/litegoldcoinmn-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LGCMN_CONFIG_H

#define LGCMN_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.litegoldcoinmn.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LiteGoldCoinMN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LiteGoldCoinMN Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "litegoldcoinmn"
