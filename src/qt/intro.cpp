...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("LiteGoldCoinMN Core"),
     ...
     * override -datadir in the litegoldcoinmn.conf file in the default data directory
     * (to be consistent with litegoldcoinmnd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
