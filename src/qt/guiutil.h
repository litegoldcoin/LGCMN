...
/** Utility functions used by the LiteGoldCoinMN Qt UI.
 */
namespace GUIUtil
{
...
// Render LiteGoldCoinMN addresses in monospace font
...
// Parse "litegoldcoinmn:" URI into recipient object, return true on successful parsing
