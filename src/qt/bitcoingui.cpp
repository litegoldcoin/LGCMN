                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("LiteGoldCoinMN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LiteGoldCoinMN address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and litegoldcoinmn: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zLGCMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About LiteGoldCoinMN Core"), this);
    aboutAction->setStatusTip(tr("Show information about LiteGoldCoinMN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LiteGoldCoinMN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LiteGoldCoinMN addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LiteGoldCoinMN addresses"));
    ...
    openAction->setStatusTip(tr("Open a LiteGoldCoinMN: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LiteGoldCoinMN Core help message to get a list with possible LiteGoldCoinMN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("LiteGoldCoinMN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LiteGoldCoinMN network", "", count));
}
...
{
    QString strTitle = tr("LiteGoldCoinMN Core"); // default title
    ...
    // Append title to "LiteGoldCoinMN - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
