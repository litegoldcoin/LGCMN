                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzLGCMNPathCustom = GetArg("-zlgcmnbackuppath", "");
    ...
    if(!strzLGCMNPathCustom.empty()) {
        ui->wallet_customzlgcmnbackuppath->setText(QString::fromStdString(strzLGCMNPathCustom));
        ui->wallet_customzlgcmnbackuppath_label->setVisible(true);
        ui->wallet_customzlgcmnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzLGCMNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the LiteGoldCoinMN RPC console.") + "<br>" +
