...
/**
 * LiteGoldCoinMN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzlgcmnseed(const UniValue& params, bool fHelp);
extern UniValue getzlgcmnseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlgcmn(const UniValue& params, bool fHelp);
extern UniValue dzlgcmnstate(const UniValue& params, bool fHelp);
