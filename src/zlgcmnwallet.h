...
#ifndef LiteGoldCoinMN_ZLGCMNWALLET_H
#define LiteGoldCoinMN_ZLGCMNWALLET_H
...
public:
    CzLGCMNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZLGCMN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZLGCMN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //LiteGoldCoinMN_ZLGCMNWALLET_H
