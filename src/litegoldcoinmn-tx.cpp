...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("LiteGoldCoinMN Core litegoldcoinmn-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  litegoldcoinmn-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded litegoldcoinmn transaction") + "\n" +
                               "  litegoldcoinmn-tx [options] -create [commands]   " + _("Create hex-encoded litegoldcoinmn transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded litegoldcoinmn transaction
