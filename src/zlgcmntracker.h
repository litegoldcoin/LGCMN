...
#ifndef LiteGoldCoinMN_ZLGCMNTRACKER_H
#define LiteGoldCoinMN_ZLGCMNTRACKER_H
...
public:
    CzLGCMNTracker(std::string strWalletFile);
    ~CzLGCMNTracker();
...
#endif //LiteGoldCoinMN_ZLGCMNTRACKER_H
